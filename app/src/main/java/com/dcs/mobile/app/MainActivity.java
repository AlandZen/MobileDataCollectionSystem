...
public class MainActivity extends ActionBarActivity
    ...
    public void onSectionAttached(int number) {
        switch (number) {
            case 1:
                mTitle = getString(R.string.title_purchase);
                break;
            case 2:
                mTitle = getString(R.string.title_produce);
                break;
            case 3:
                mTitle = getString(R.string.title_sall);
                break;
            case 4:
                mTitle=getString(R.string.title_warehouse);
                break;
        }
    }
